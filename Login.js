...
async function LogIn(params) {
    ...
    try{
        ...
        //Click the following fields Fullname, email, current address, password Field, button
        ...
        const buttonElement = await driver.findElement(By.xpath('//*[@id="TextForm"]/div[5]/input')); 
